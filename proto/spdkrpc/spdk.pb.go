...
type EngineCreateRequest struct {
	...
	CtrlrLossTimeout     int32             `protobuf:"varint,6,opt,name=ctrlr_loss_timeout,json=ctrlrLossTimeout,proto3" json:"ctrlr_loss_timeout,omitempty"`
	ReconnectDelay       int32             `protobuf:"varint,7,opt,name=reconnect_delay,json=reconnectDelay,proto3" json:"reconnect_delay,omitempty"`
	FastIoFailTimeout    int32             `protobuf:"varint,8,opt,name=fast_io_fail_timeout,json=fastIoFailTimeout,proto3" json:"fast_io_fail_timeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *EngineCreateRequest) GetCtrlrLossTimeout() int32 {
	if m != nil {
		return m.CtrlrLossTimeout
	}
	return 0
}

func (m *EngineCreateRequest) GetReconnectDelay() int32 {
	if m != nil {
...
func (m *EngineCreateRequest) GetFastIoFailTimeout() int32 {
	if m != nil {
		return m.FastIoFailTimeout
	}
	return 0
}
...
var fileDescriptor_f86dfec2b2acc42c = []byte{
	...
	,
}
