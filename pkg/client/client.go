...
func (c *SPDKClient) EngineSnapshotClone(name, snapshotName, srcReplicaName, srcReplicaAddress, dstReplicaName, dstReplicaAddress string, cloneMode spdkrpc.CloneMode) error {
	if err := util.VerifyParams(
		util.Param{"name", name},
		util.Param{"snapshotName", snapshotName},
		util.Param{"srcReplicaName", srcReplicaName},
		util.Param{"srcReplicaAddress", srcReplicaAddress},
		util.Param{"dstReplicaName", dstReplicaName},
		util.Param{"dstReplicaAddress", dstReplicaAddress},
	); err != nil {
	...
	return errors.Wrapf(err, "failed to clone snapshot for SPDK engine: name = %s, snapshotName = %s, "+
		"srcReplicaName = %s, srcReplicaAddress = %v, dstReplicaName = %v, dstReplicaAddress = %v",
		name, snapshotName, srcReplicaName, srcReplicaAddress, dstReplicaName, dstReplicaAddress)
}
