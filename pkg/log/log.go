...
// UpdateLoggerWithWarn updates the logger with new fields thread-safely and logs a warning if it fails.
func (s *SafeLogger) UpdateLoggerWithWarn(fields logrus.Fields, msg string) {
