...
type EngineSnapshotCloneRequest struct {
	...
	DstReplicaSrcReplicaPairMap map[string]string   `protobuf:"bytes,11,rep,name=dst_replica_src_replica_pair_map,json=dstReplicaSrcReplicaPairMap,proto3" json:"dst_replica_src_replica_pair_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // dst replica name -> src replica name
}
